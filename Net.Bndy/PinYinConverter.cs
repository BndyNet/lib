...
// Created by Bndy at 11/16/2016 20:14:52
// --------------------------------------------------------------------------
// Chinese to PinYin
// ==========================================================================
...
namespace Net.Bndy
{
    ...
    {
        public static Dictionary<char, string> HanPinyinDic = new Dictionary<char, string>() {
            {'濛', "Meng"}
        };
        ...
        {
            if (HanPinyinDic.ContainsKey(ch)) return HanPinyinDic[ch];
